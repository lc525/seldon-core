...
{% @github-files/github-code-block url="https://github.com/SeldonIO/seldon-core/blob/release-2.11/scheduler/config/kafka-internal.json" %}
{% @github-files/github-code-block url="https://github.com/SeldonIO/seldon-core/blob/release-2.11/scheduler/config/kafka-internal.json" %}
...
{% @github-files/github-code-block url="https://github.com/SeldonIO/seldon-core/blob/release-2.11/k8s/yaml/components.yaml" %}
...
{% @github-files/github-code-block url="https://github.com/SeldonIO/seldon-core/blob/release-2.11/k8s/samples/values-runtime-kafka-compression.yaml" %}
...
{% @github-files/github-code-block url="https://github.com/SeldonIO/seldon-core/blob/release-2.11/scheduler/config/tracing-internal.json" %}
...
{% @github-files/github-code-block url="https://github.com/SeldonIO/seldon-core/blob/release-2.11/scheduler/k8s/config/tracing.yaml" %}
