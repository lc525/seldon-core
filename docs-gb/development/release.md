...
The [Draft New Release](https://github.com/SeldonIO/seldon-core/blob/release-2.11/.github/workflows/draft-release.yml) workflow is the
...
The [Build docker images](https://github.com/SeldonIO/seldon-core/blob/release-2.11/.github/workflows/images.yml) workflow is the
