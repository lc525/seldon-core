...
const numberOfScenarios = 5
var scenarioDuration = getConfig().constantRateDurationSeconds/numberOfScenarios
...
export const options = {
    ...
    scenarios: {
        constant_request_rate_1: {
            ...
            timeUnit: '1s',
            duration: scenarioDuration.toString()+'s',
            preAllocatedVUs: 1, // how large the initial pool of VUs would be
            maxVUs: 1000, // if the preAllocatedVUs are not enough, we can initialize more
        },
        constant_request_rate_2: {
            startTime: scenarioDuration.toString()+'s',
            executor: 'constant-arrival-rate',
            rate: getConfig().requestRate,
            timeUnit: '1s',
            duration: scenarioDuration.toString()+'s',
